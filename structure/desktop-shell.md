...
window and loads a deferred dashboard, including when a usage popup is visible. This is separate
from the single-instance callback, which handles a second process notifying the existing one.
